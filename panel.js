function openPanel(){
    document.getElementById("panel").classList.toggle("changePanel");
    document.getElementById("manager").classList.toggle("changeSize");
}
...
function downloadServerFile() {
    const forkValue = document.getElementById("fork").value;
    const verValue = document.getElementById("versions").value;
